...
public class PackageData {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("PackageData{");
        sb.append("msgHeader=").append(msgHeader);
        sb.append(", msgBodyBytes=").append(Arrays.toString(msgBodyBytes));
    ...
    public static class MsgHeader {
        ...
        @Override
        public String toString() {
            final StringBuilder sb = new StringBuilder("MsgHeader{");
            sb.append("msgId=").append(msgId);
            sb.append(", msgBodyPropsField=").append(msgBodyPropsField);
            sb.append(", msgBodyLength=").append(msgBodyLength);
            sb.append(", encryptionType=").append(encryptionType);
            sb.append(", hasSubPackage=").append(hasSubPackage);
            sb.append(", reservedBit='").append(reservedBit).append('\'');
            sb.append(", terminalPhone='").append(terminalPhone).append('\'');
            sb.append(", flowId=").append(flowId);
            sb.append(", packageInfoField=").append(packageInfoField);
            sb.append(", totalSubPackage=").append(totalSubPackage);
            sb.append(", subPackageSeq=").append(subPackageSeq);
            sb.append('}');
            return sb.toString();
        }
    }
